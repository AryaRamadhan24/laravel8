                        ...
                        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                            ...
                            <div class="dropdown no-arrow">
                                ...
                                <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in"
                                    ...
                                    <a class="dropdown-item" href="{{ url('/editpenyakit/' . $item->id) }}">Update</a>
                                    <a class="dropdown-item" href="{{ url('/deletepenyakit/' . $item->id) }}" >Delete
                                        {{-- <form method="POST" action="{{ url('/deletepenyakit/' . $item->id) }}" id="delete{{$item->id}}">
                                            @csrf
                                            @method('DELETE')
                                        </form> --}}
                                    </a>
